...
public class PolicyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView privacy_textbox = view.findViewById(R.id.privacy_policy_textview);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            privacy_textbox.setText(Html.fromHtml(privacy_policy_text, Html.FROM_HTML_MODE_COMPACT));
        } else {
            privacy_textbox.setText(Html.fromHtml(privacy_policy_text));
        }
